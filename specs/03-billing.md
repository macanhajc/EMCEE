...
- **No prepaid blocks** — Pix Automático makes recurring work without them (rejected 2026-07-19). Still true: prepaid blocks would have meant pre-buying N future recurring cycles, which Lifetime is not — it's a single permanent entitlement, not a workaround for making recurring payments easier.
