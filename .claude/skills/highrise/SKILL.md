...
- Actions: `self.highrise.*` — chat/whisper, emote, reaction, teleport/walk, moderate_room (mute/kick/ban), inventory, wallet + purchases, room boost, voice time, DM conversations. Public game data: `self.webapi`.
...
- Whether designer-rights bots can ban or only kick/mute; mute duration parameters; unban API.
